import { useIsPlaying } from "../features/PlayerSlice";
...
const MainButton = ({onClick, title}) => {
    ...
    return (<div title={title} className={`main-button ${isPlaying ? 'on' : 'off'}`} >
        <div className='outer'></div>
        <div className='wave'></div>
        <svg fill="currentColor" fillRule="evenodd" viewBox="0 0 47.8126 47.8126" onClick={() => onClick?.()} xmlns="http://www.w3.org/2000/svg">
            <defs>
            ...
            <path fill="url(#grad)" d={isPlaying
